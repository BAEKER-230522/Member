package com.baeker.member.global.security.jwt;

import com.baeker.member.base.error.exception.jwt.JwtException;
...
import static com.baeker.member.base.error.ErrorResponse.JWT_INVALID_EXCEPTION;
...
//    }
    ...
    public JwtTokenResponse createNewAccessToken(String refreshToken) throws IOException {
        ...
        long id = (int) claims.get("id");
        member = memberQueryUseCase.findById(id);
    ...
    public String getClaimValue(String token, String key){
        ...
        throw new JwtException(JWT_INVALID_EXCEPTION.getMessage());
    }
